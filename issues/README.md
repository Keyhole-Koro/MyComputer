...
| MYOS-012 | [DOM Inspector CLI（MyDOMTester 拡張）](tickets/MYOS-012_dom-inspector-cli.md) | In Progress | フェーズ1（`make dom-inspect`、watch/diff/node詳細）実装済み。フェーズ2（prop書き込み）は未着手。 |
